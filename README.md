...
### [Косое дерево (B)](Module%201/A/1A_sum.py)
...
### [Min-куча (C)](Module%201/B/1B_dequeue.py)
...
### [Фильтр Блума (B)](Module%203/B/3B_bloom.py)
...
### [Приближенный рюкзак (C)](Module%201/C/1C_dependencies.py)
