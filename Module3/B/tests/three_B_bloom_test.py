...
from Module3.B.three_B_bloom import handler

INPUT_TEMP = 'input/{}.txt'  # путь до входных данных
ANSWER_TEMP = 'answer/{}.txt'  # путь до ответов

FIRST_NUM = 1  # номер первого теста
LAST_NUM = 24  # номер последнего теста
SKIP_NUM = []  # номера тестов для пропуска


class BloomTestClass(unittest.TestCase):
    def setUp(self):
